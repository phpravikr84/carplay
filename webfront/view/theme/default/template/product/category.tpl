        ...
        <div class="col-md-12">
          <ul class="search">
            ...
            <li class="search"> <i class="fa fa-star" aria-hidden="true"></i>
              <div class="container">
               <select name="rating" id="sortBy" class="form-control ">
                  <option value="">star rating</option>
                  <option value="maxpricelevel">stars(5...1)</option>
                  <option value="minpricelevel">stars(1...5)</option>
                </select>
              </div>
            </li>
          </ul>
