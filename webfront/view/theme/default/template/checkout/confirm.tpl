    ...
    <div id="content" class="<?php echo $class; ?> mar_top65">
      ...
      <div class="checkout-area">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#paneOne1" data-toggle="tab" role="tab" aria-controls="tab1">Pay through Paypal</a></li>
        ...
        <div class="card-header xsmall grey-text mb10 relative">
          <div class="fr">
            <div class="secure lt-grey-text">
                  ...
                  128 Bit encryption by Paypal</i></span> </div>
            </div>
              <div class="clear"></div>
          </div>
        </div>
        ...
        <br/>
        <input type="hidden" name="itemname"  id="itemname" value="<?php echo $bookingServices; ?>" /> 
            <input type="hidden" name="itemnumber" id="itemnumber" value="20000" /> 
            <input type="hidden" name="itemdesc" id="itemdesc" value="<?php echo $bookingMerchantName; ?> <?php echo $address; ?>" /> 
            <input type="hidden" name="itemprice" id="itemprice" value="<?php echo $bookingPrice; ?>" />
            <input type="hidden" name="currency" id="currency" value="<?php echo $currencyname; ?>">
            <input type="hidden" name="itemQty" id="itemQty" value="1" />
 
            <a href="javascript:void(0)" id="confirmReservationPaypalExpress" class="contin collapsed" aria-expanded="false">Confirm Reservation</a> 
...
$('#confirmReservationPaypalExpress').on('click', function() { //alert('hi');

  //alert($("form#paypal input[type=text]"));
...
var dataString = 'itemname='+ itemname + '&itemnumber='+ itemnumber + '&itemQty='+ itemQty + '&itemdesc='+ itemdesc + '&itemprice='+ itemprice + '&currencyname=' + currencyname;
            
              //alert(cardDetails);
  $.ajax({
    url: 'index.php?route=payment/ppexpressprocess/sendPaypalPayment&paypal=checkout',
    type: 'post',
  //   dataType: 'json',
  // async: false,
  // data: {itemname: itemname, itemnumber: itemnumber, itemQty: itemQty, itemprice: itemprice},
  data:dataString,
