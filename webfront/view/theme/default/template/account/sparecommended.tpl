...
<div class="row info">
<div class="col-md-12">
    <h1>Can’t find a specific salon?</h1>
    <p>Are you a fan of a particular salon and would you like to book it through Riwigo? Let us know.</p>
    <p>Fill in the details below and we will pick it up.</p>
...
<div class="row form">
<form role="form" name="salonsparecommendedForm" action="index.php?route=account/sparecommended" method="post">
...
<script>
$(function() {
  $("form[name='salonsparecommendedForm']").validate({
