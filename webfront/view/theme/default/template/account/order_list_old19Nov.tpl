          ...
          <div class="tab-content">
            ...
            <div id="menu1" class="tab-pane fade">
              ...
              <div class="hotel_booking">
                <div class="pic_hotel"> <img src="<?=$order['thumb']?>" class="static" alt="" height="100" width="120"> </div>
                <div class="detail_hotel_booking">
                  <p class="content_blue"> <b> <a class="hotelLinks" href="#" title="Pinnacle Grand Jomtien Resort">
                    <?=$order['merchant_name']?>
                    </a> </b> </p>
                  <p class="address_hotel">
                    <?=$order['address']?>
              ...
              <div class="allbox">
                      ...
                      <div class="allbox_right">
                        ...
                        <p><span><?php echo $order['disc_amount']; ?></span></p>
                        <div>
                          <p class="text_conditions"> <a onclick=" javascript:return false; " title="This booking is Non-Refundable and cannot be amended or modified. Failure to arrive at your hotel will be treated as a No-Show and no refund will be given (Hotel policy).">Booking Conditions</a> </p>
                        </div>
                        <div class="manage_booking">
                          <div> <a href="<?php echo $order['view']; ?>" target="blank">view booking</a> <span class="sprite_arrow pic_arrow1" style="*margin-bottom: 2px !important;"></span> </div>
                          <?php if($order['status'] != 'Canceled'){?>
