<?php
class ControllerAccountSpaRecommended extends Controller {
	private $error = array();
	...
	public function index() {
			...
			$this->model_account_spa->addMerchantRecommended($data);
		...
		$this->response->setOutput($this->load->view('account/sparecommended', $data));
	}
