...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_footer5'] = $this->language->get('text_footer5');
		$data['text_button'] = $this->language->get('text_button');
		$data['text_button1'] = $this->language->get('text_button1');
		...
		$data['howrw'] = $this->url->link('information/information', 'information_id=10');
