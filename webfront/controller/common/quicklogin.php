...
class ControllerCommonQuicklogin extends Controller {
	...
	if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/quicklogin')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/quicklogin', $data);
		} else {
			return $this->load->view('common/quicklogin', $data);
		}
	}
}