...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['txt_media'] = $this->language->get('txt_media');
		...
		$data['blog'] = $this->url->link('pavblog/blogs', '', true);
		...
		$data['searchmenu'] = $this->url->link('product/category', 'path=18', true);
		$data['howriwigoWorks'] = $this->url->link('information/information', 'information_id=10', true);
