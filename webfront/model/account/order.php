...
class ModelAccountOrder extends Model {
	...
	public function getOrderProductOrderID($order_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "'");

		return $query->row;
	}
	
	public function getOrderProductsMobile($order_id) {
		$query = $this->db->query("SELECT name,bookingDiscountTime, persons,duration,discount,price,disc_amount,total FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "'");
