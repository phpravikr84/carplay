...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_order_merchant_name'])) {
			$filter_order_merchant_name = $this->request->get['filter_order_merchant_name'];
		} else {
			$filter_order_merchant_name = null;
		}
		...
		if (isset($this->request->get['filter_order_service_name'])) {
			$filter_order_service_name = $this->request->get['filter_order_service_name'];
		} else {
			$filter_order_service_name = null;
		}
		...
		if (isset($this->request->get['filter_order_merchant_name'])) {
			$url .= '&filter_order_merchant_name=' . $this->request->get['filter_order_merchant_name'];
		}

		if (isset($this->request->get['filter_order_service_name'])) {
			$url .= '&filter_order_service_name=' . $this->request->get['filter_order_service_name'];
		}
		...
		if(!empty($this->session->data['merchant_id']) && $this->session->data['merchant_id'] !=0){ 
		...
		$filter_data = array(
			...
			'filter_order_merchant_name' => $filter_order_merchant_name,
			'filter_order_service_name'	=> $filter_order_service_name,
		...
		$order_total_filter = $this->model_sale_order->getCountOrdersFilter($filter_data);
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'disocuntTime'=> $result['disocuntTime'],
			...
			$persons = $persons + $result['persons'];
		}

		$data['heading_title'] = $this->language->get('heading_title');

		$data['text_today_date'] = date('d M Y');
		
		$data['covers'] = $persons;
		
		$data['reservation'] = $order_total;
		$data['reservation_filter'] = $order_total_filter;
		...
		$filter_data = array(
			...
			'filter_merchant_id'   => $filter_merchant_id,
			'filter_customer'	   => $filter_customer,
			'filter_order_status'  => 3, // For Attended
			'filter_total'         => $filter_total,
			'filter_order_merchant_name' => $filter_order_merchant_name,
			'filter_order_service_name'	=> $filter_order_service_name,
			'filter_date_added'    => $filter_date_added,
		...
		$data['attended'] = $this->model_sale_order->getTotalOrders($filter_data);
		...
		$filter_data = array(
			...
			'filter_merchant_id'   => $filter_merchant_id,
			'filter_customer'	   => $filter_customer,
			'filter_order_status'  => 10, // No Show
			'filter_total'         => $filter_total,
			'filter_order_merchant_name' => $filter_order_merchant_name,
			'filter_order_service_name'	=> $filter_order_service_name,
			'filter_date_added'    => $filter_date_added,
		...
		$data['noshow'] = $this->model_sale_order->getTotalOrders($filter_data);
		...
		$filter_data = array(
			...
			'filter_merchant_id'   => $filter_merchant_id,
			'filter_customer'	   => $filter_customer,
			'filter_order_status'  => 4, // Cancelled
			'filter_total'         => $filter_total,
			'filter_order_merchant_name' => $filter_order_merchant_name,
			'filter_order_service_name'	=> $filter_order_service_name,
			'filter_date_added'    => $filter_date_added,
		...
		$data['cancelled'] = $this->model_sale_order->getTotalOrders($filter_data);
		...
		$data['upcoming'] = $this->model_sale_order->getTotalOrders($filter_data);
		...
		$data['entry_order_merchant_name']	= $this->language->get('entry_order_merchant_name');
		$data['entry_order_service_name'] = $this->language->get('entry_order_service_name');
		...
		$data['filter_order_merchant_name'] = $filter_order_merchant_name;
		$data['filter_order_service_name'] = $filter_order_service_name;
		...
		//getting merchant name and product name
		$this->load->model('catalog/merchant');
		
		$data['merchantdetails'] = $this->model_catalog_merchant->getMerchantAll();
		$data['servicedetails']	= $this->model_catalog_merchant->getMerchantAllServices();

		if (isset($this->request->get['filter_order_merchant_name'])) {

			$data['filter_merchant_name'] =  $this->model_catalog_merchant->getMerchantNameByMerchantId($this->request->get['filter_order_merchant_name']);
		}
	...
	public function info() {
		...
		//print '<pre>'; print_r($order_info);exit;
		if ($order_info) {
			$this->load->language('sale/order');
			...
			$data['booking_date'] = date($this->language->get('date_format_short'), strtotime($order_info['booking_date']));
			...
			$data['mobile'] = $order_info['mobile'];
			$data['gender'] = ucfirst($order_info['gender']);
			$data['shipping_method'] = $order_info['shipping_method'];
			$data['payment_method'] = $order_info['payment_method'];
			
			$this->load->model('catalog/merchant');
			$merchant_info = $this->model_catalog_merchant->getMerchant($order_info['merchant_id']);
			
			$data['merchant_name'] = $merchant_info['name'];
			$data['merchant_address'] = $merchant_info['address'];
			$data['merchant_phone'] = $merchant_info['phone'];
			$data['merchant_mobile'] = $merchant_info['mobile'];
			...
			foreach ($products as $product) { //print $product['name'];
				...
				$data['products'][] = array(
					...
					'bookingDiscountTime'   		   => $product['bookingDiscountTime'],
					'discount'    		   => $product['discount'],
					'sub_total'    		   =>  $this->currency->format($product['sub_total'] + ($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
					'reward'    		   => $product['reward'],

					'price'    		   => $this->currency->format($product['price'] + ($this->config->get('config_tax') ? $product['tax'] : 0), $order_info['currency_code'], $order_info['currency_value']),
					'total'    		   => $this->currency->format($product['total'] + ($this->config->get('config_tax') ? ($product['tax'] * $product['persons']) : 0), $order_info['currency_code'], $order_info['currency_value']),
			...
			if($this->user->getGroupId() == 10){
				...
				foreach ($order_statuses as $order_status) {
					if (in_array($order_status['order_status_id'], $status)){
			...
			//print '<pre>'; print_r($data['order_statuses']);exit;
