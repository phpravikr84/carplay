...
class ControllerUserMerchant extends Controller {
	...
	public function index() {
		$this->load->language('user/merchant');
	...
	protected function getForm() {
		...
		$data['entry_merchants'] = $this->language->get('entry_merchants');
		...
		if (isset($this->error['merchants'])) {
			$data['error_merchants'] = $this->error['merchants'];
		} else {
			$data['error_merchants'] = '';
		}
		...
		$data['merhcnats'] = $this->model_catalog_merchant->getMerchants();
		
		//print "<pre>";print_r($data['merhcnats']);exit;
		...
		$this->response->setOutput($this->load->view('user/merchant_form', $data));
	}
	...
	protected function validateForm() {
		...
		if (utf8_strlen(trim($this->request->post['merchant_id'])) == '') {
			$this->error['merchants'] = $this->language->get('error_merchants');
		}
