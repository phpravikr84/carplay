...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_limit_admin'] = $this->language->get('entry_limit_admin');
                ...
                $data['entry_fb_sec'] = $this->language->get('entry_fb_sec');
		...
		if (isset($this->request->post['config_limit_admin'])) {
			...
			$data['config_fb_app_id'] = $this->config->get('config_fb_app_id');
                ...
                if (isset($this->request->post['config_fb_sec'])) {
			$data['config_fb_sec'] = $this->request->post['config_fb_sec'];
		} else {
			$data['config_fb_sec'] = $this->config->get('config_fb_sec');
		}
