...
class ControllerLocalisationCity extends Controller {
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('localisation/city', 'token=' . $this->session->data['token'] . '&sort=z.name' . $url, true);
		$data['sort_code'] = $this->url->link('localisation/city', 'token=' . $this->session->data['token'] . '&sort=z.code' . $url, true);
	...
	public function city() {
		...
		$city_info = $this->model_localisation_city->getCitysByZoneId($this->request->get['zone_id']);

		if ($city_info) {
				foreach ($city_info as $result) {
