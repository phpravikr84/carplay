        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                <legend>Social App Detail</legend>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-fb_app_id"><span data-toggle="tooltip" title=""><?php echo $entry_fb_app_id; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_fb_app_id" value="<?php echo $config_fb_app_id; ?>" placeholder="<?php echo $entry_fb_app_id; ?>" id="input-admin-limit" class="form-control" />
                     
                  </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-fb_sec"><span data-toggle="tooltip" title=""><?php echo $entry_fb_sec; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_fb_sec" value="<?php echo $config_fb_sec; ?>" placeholder="<?php echo $entry_fb_sec; ?>" id="input-admin-limit" class="form-control" />
