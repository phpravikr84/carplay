    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-user-group"><?php echo $entry_merchants; ?></label>
            <div class="col-sm-10">
              <select name="merchant_id" id="input-merchants" class="form-control">
              <option value="0">Admin</option>
                <?php foreach ($merhcnats as $merchant) { ?>
              ...
              <?php if ($error_merchants) { ?>
              <div class="text-danger"><?php echo $error_merchants; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
