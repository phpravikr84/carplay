          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <?php if(isset($merchant_description[$language["language_id"]]["location_id"])){ $location_id = $merchant_description[$language["language_id"]]["location_id"];}else{ $location_id = 0;}?>     
                      <select   onChange="selectLocation(this, '<?php echo $language["language_id"]; ?>', '<?php echo $cityid;?>','<?php echo $location_id;?>')"   name="merchant_description[<?php echo $language['language_id']; ?>][city_id], <?php echo $location_id;?>" id="input-city<?php echo $language['language_id']; ?>" class="form-control"></select>
            ...
            <div class="tab-pane" id="tab-data"> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="location_map" id="us3-address" value="<?php echo $location_map; ?>" placeholder="<?php echo $entry_location_map; ?>" id="input-location_map" class="form-control" /> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="latitude" id="us3-lat"  value="<?php echo $latitude; ?>" placeholder="<?php echo $entry_latitude; ?>" id="input-latitude" class="form-control" />
                </div>
                <label class="col-sm-2 control-label" for="input-location-map"><?php echo $entry_longitude; ?></label>
                <div class="col-sm-3">
                  <input type="text" name="longitude" id="us3-lon"  value="<?php echo $longitude; ?>" placeholder="<?php echo $entry_longitude; ?>" id="input-longitude" class="form-control" />
                </div>
              </div>
            </div> 
