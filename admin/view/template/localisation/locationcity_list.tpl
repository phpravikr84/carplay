        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-zone">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.name') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"> <?php echo $column_zone; ?> </td>
              ...
              <tbody>
                <?php if ($citys) { ?>
                <?php foreach ($citys as $zone) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($zone['city_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $zone['city_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $zone['city_id']; ?>" />
                    <?php } ?></td>
				  <td class="text-left"><?php echo $zone['country']; ?></td>
                  <td class="text-left"><?php echo $zone['zone']; ?></td>
                  <td class="text-left"><?php echo $zone['city']; ?></td> 
