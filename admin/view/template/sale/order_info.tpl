  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3">
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              <tr>
                <td><button data-toggle="tooltip" title="Order Id" class="btn btn-info btn-xs"><i class="fa fa-credit-card fa-fw"></i></button></td>
                <td><h2><?php echo $order_id; ?></h2></td>
              </tr>
      ...
      <div class="col-md-3">
        <div class="panel panel-default">
          ...
          <table class="table">
            ...
            <tr>
              <td><button data-toggle="tooltip" title="<?php echo 'Gender'; ?>" class="btn btn-info btn-xs"><i class="fa fa-intersex fa-fw"></i></button></td>
      ...
      <div class="col-md-3">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-shopping-cart"></i> Merchant Detail</h3>
          </div>
          <table class="table">
            <tbody>
              <tr>
                <td><button data-toggle="tooltip" title="Merchant Name" class="btn btn-info btn-xs"><i class="fa fa-user fa-fw"></i></button></td>
                <td><?php echo $merchant_name; ?></td>
              </tr>
              <tr>
                <td style="width: 1%;"><button data-toggle="tooltip" title="Merchant Address" class="btn btn-info btn-xs"><i class="fa fa-shopping-cart fa-fw"></i></button></td>
                <td><?php echo $merchant_address; ?></td>
              </tr>
              <tr>
                <td><button data-toggle="tooltip" title="Merchant Phone" class="btn btn-info btn-xs"><i class="fa fa-phone fa-fw"></i></button></td>
                <td><?php echo $merchant_phone; ?></td>
              </tr>
              <tr>
                <td><button data-toggle="tooltip" title="<?php echo $text_payment_method; ?>" class="btn btn-info btn-xs"><i class="fa fa-phone fa-fw"></i></button></td>
        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                <td  colspan="2"><select name="order_status_id" id="input-order-status" class="form-control">
                ...
                <td><div class="text-right">
                    <button class="btn btn-primary" data-loading-text="Loading..." id="button-history"><i class="fa fa-plus-circle"></i> Add Status</button>
                  </div></td>
              </tr>
            </tbody>
          </table>
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <td class="text-right">Persons</td> 
              <td class="text-right">Per Person</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php echo $product['duration']; ?></td>
              <td class="text-right"><?php echo $product['bookingDiscountTime']; ?></td>
            ...
            <?php if($i==3){?>
            <tr>
              <td colspan="5" class="text-right"><h3><strong><?php echo $total['title']; ?></strong></h3></td>
              <td class="text-right"><h3><strong><?php echo $total['text']; ?></strong></h3></td>
            </tr>
            <?php }else{?>
            <tr>
