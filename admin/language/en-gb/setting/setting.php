...
$_['entry_theme']                     = 'Theme';
$_['entry_name']                      = 'Admin Office Name';
$_['entry_owner']                     = 'Admin Office Owner';
...
$_['entry_fb_sec']                    = 'Facebook App Seceret';



// Help
$_['help_geocode']                    = 'Please enter your Office location geocode manually.';
$_['help_open']                       = 'Fill in your Office\'s opening times.';
$_['help_comment']                    = 'This field is for any special notes you would like to tell the customer i.e. Store does not accept cheques.';
$_['help_location']                   = 'The different Office locations you have that you want displayed on the contact us form.';
$_['help_currency']                   = 'Change the default currency. Clear your browser cache to see the change and reset your existing cookie.';
$_['help_currency_auto']              = 'Set your Office to automatically update currencies daily.';
$_['help_limit_admin']   	          = 'Determines how many admin items are shown per page (orders, customers, etc).';
$_['help_product_count']              = 'Show the number of products inside the subcategories in the Officefront header category menu. Be warned, this will cause an extreme performance hit for Offices with a lot of subcategories!';
...
$_['help_review_mail']                = 'Send an email to the Office owner when a new review is created.';
...
$_['help_tax_default']                = 'Use the Office address to calculate taxes if customer is not logged in. You can choose to use the Office address for the customer\'s shipping or payment address.';
...
$_['help_account_mail']               = 'Send an email to the Office owner when a new account is registered.';
...
$_['help_order_mail']                 = 'Send an email to the Office owner when a new order is created.';
...
$_['help_affiliate_mail']             = 'Send an email to the Office owner when a new affiliate is registered.';
...
$_['help_ftp_root']                   = 'The directory your OpenCart installation is Officed in. Normally \'public_html/\'.';
$_['help_mail_protocol']              = 'Only choose \'Mail\' unless your host has disabled the php mail function.';
$_['help_mail_parameter']             = 'When using \'Mail\', additional mail parameters can be added here (e.g. -f email@Officeaddress.com).';
...
$_['help_mail_alert']                 = 'Any additional emails you want to receive the alert email, in addition to the main Office email. (comma separated).';
...
$_['help_shared']                     = 'Try to share the session cookie between Offices so the cart can be passed between different domains.';
...
$_['help_maintenance']                = 'Prevents customers from browsing your Office. They will instead see a maintenance message. If logged in as admin, you will see the Office as normal.';
