...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="index.php" class="btn pull-right" style="margin-bottom: 20px;">View Discounts</a>
		
      <div class="clearfix"></div>
        
      <div class="box">
        <div class="header"><h4>Add Discount</h4></div>
        <div class="content pad"> 
            ...
            <form id="add_event">
                ...
                <button type="submit" onclick="calendar.save()" class="btn btn-primary pull-right">Add Discount</button>
