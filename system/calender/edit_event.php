...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="index.php?merchant_id=<?php echo $info['merchant_id']; ?>" class="btn pull-right" style="margin-bottom: 20px;">View Discounts</a>
		
      <div class="clearfix"></div>
        
      <div class="box">
        <div class="header"><h4>Edit Discount</h4></div>
