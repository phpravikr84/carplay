			...
			({
				...
				calendar.update_this = function(id, title, description, url, construct_two)
				{
					if(opt.version == 'modal')
					{
						...
						// PHP Mode
						var construct = "id="+id+"&title="+title+"&description="+description[6]+"&color="+description[7]+"&start_date="+description[8]+"&start_time="+description[9]+"&end_date="+description[10]+"&end_time="+description[11]+"&discount="+description[12]+"&seats="+description[13];
					}	
